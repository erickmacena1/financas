...
function App() {
  ...
  const [investmentPercent, setInvestmentPercent] = useState(undefined)
  const [leisurePercent, setLeisurePercent] = useState(undefined)
  
  const [investmentValue, setInvestmentValue] = useState(undefined)
  const [leisureValue, setLeisureValue] = useState(undefined)
  const [remainingValue, setRemainingValue] = useState(undefined)
  const [remainingPercent, setRemainingPercent] = useState(undefined)
